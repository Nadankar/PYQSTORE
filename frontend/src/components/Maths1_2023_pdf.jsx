...
import math1_2023_pdf from "../Allpdf_json_file/math1_2023_pdf.json"

function Maths1_2023_pdf() {
  return (
    ...
    <div className="max-w-screen-2xl container mx-auto md:px-20 px-4 mt-20 grid justify-center  ">
      <div className="overflow-x-auto">
        <table className="table">
          ...
          <tbody>
            {math1_2023_pdf.pdfs.map((pdf, index) => (
              <tr key={index}>
                <th>{index + 1}</th>
                <td>{pdf.pdfname}</td>
...
export default Maths1_2023_pdf
