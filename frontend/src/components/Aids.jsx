  ...
  return (
    ...
    <div className="max-w-screen-2xl container mx-auto md:px-20 px-4 pt-20  ">
      <div className=" text-center justify-items-center">
         ...
         <p className="mt-10">
         "Explore our collection of previous year question papers for <span className="text-yellow-600">AI&DS Engineering</span> from 2022 and 2023. Equip yourself with essential resources to excel in your exams and gain a deeper understanding of your coursework."
         </p>
         <Link to="/">
